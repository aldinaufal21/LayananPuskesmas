                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">{{ __('Masuk Akun') }}</h1>
                                    </div>
                                    <form class="user" action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="customCheck">{{ __('Remember
                                                    Me') }}</label>
                                            </div>
                                        </div>
                                        <input type="submit" name="submit" value="{{ __('Login') }}" class="btn btn-primary btn-user btn-block">
                                    </form>
                                    <hr>
                                    <div class="text-center">
